...
namespace NHibernate.NodaTime.Linq
{
    public static class DynamicClassFactory
    {
        ...
        private static readonly ConcurrentDictionary<string, System.Type> GeneratedTypes = new ConcurrentDictionary<string, System.Type>();
        ...
        private static readonly System.Type EqualityComparer = typeof(EqualityComparer<>);
        private static readonly System.Type EqualityComparerGenericArgument = EqualityComparer.GetGenericArguments()[0];
#if WINDOWS_APP || DOTNET5_1 || UAP10_0 || NETSTANDARD
    ...
    {
#if !NETFRAMEWORK
        public static System.Type CreateType(this TypeBuilder tb)
        {
        ...
        public static System.Type AsType(this TypeBuilder builder)
        {
            return builder.GetTypeInfo().AsType();
        }

        public static System.Type AsType(this GenericTypeParameterBuilder builder)
        {
            return builder.GetTypeInfo().AsType();
        }
#endif
