...
{
    public class TzdbZonedDateTimeAsUtcDateTimeType : AbstractTwoPropertyStructType<ZonedDateTime, DateTime, DateTimeZone, UtcDateTimeType,CustomType<TzdbDateTimeZoneType>>
    {
