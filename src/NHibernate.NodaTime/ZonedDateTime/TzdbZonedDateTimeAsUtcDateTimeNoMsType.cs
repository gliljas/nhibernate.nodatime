...
{
    public class TzdbZonedDateTimeAsUtcDateTimeNoMsType : AbstractTwoPropertyStructType<ZonedDateTime, DateTime, DateTimeZone, UtcDateTimeNoMsType, CustomType<TzdbDateTimeZoneType>>
    {
